...
Working on some of the projects in Martyr2’s Mega Project List.
The list can be found at http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/.

The Problems
------------

The problems are grouped by topic. Note that some could be placed in
multiple topics.
